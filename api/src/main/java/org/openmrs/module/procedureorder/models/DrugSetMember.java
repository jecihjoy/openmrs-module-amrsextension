...
public class DrugSetMember extends OrderSetMemberExt {
	...
	/*	@Id
		...
		@Column(name = "drug_order_set_member_id")
		private int drugOrderSetMember;*/
	...
	/*	@Override
		public Integer getId() {
			return getDrugOrderSetMember();
		}
		
		@Override
		public void setId(Integer id) {
			setDrugOrderSetMember(id);
		}
		
		public int getDrugOrderSetMember() {
			return drugOrderSetMember;
		}
		
		public void setDrugOrderSetMember(int drugOrderSetMember) {
			this.drugOrderSetMember = drugOrderSetMember;
		}
		*/
